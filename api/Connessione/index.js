...
module.exports = async function (context, req) {
  ...
  collection= database.collection("Dipendence")
  var dependence= await collection.find({}).toArray();
   context.res = {
    status: 200,
    body: {"users":list,"prenotazioni":preno,"luoghi":luoghi,"dependence":dependence},
  };
